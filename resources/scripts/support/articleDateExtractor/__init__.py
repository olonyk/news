""" This script has been edited to be able to run in python3.5, but all credits for this script 
    should go to the original author Ran Geva. The original code was downloaded from 
    https://github.com/Webhose/article-date-extractor 2017-10-11.
    Changes has been noted with a comment.
"""
